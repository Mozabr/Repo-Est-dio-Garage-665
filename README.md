...
> **Retomada em outra conta/computador:** comece por [COMECE-AQUI.md](COMECE-AQUI.md) e depois leia [HANDOFF.md](HANDOFF.md). Consulte [MODOS-DE-USO.md](MODOS-DE-USO.md) para operar neste Mac, em outro computador ou em outro chat. Há também um [prompt pronto para retomar](PROMPT-PARA-RETOMAR.md). O capô v25 está aprovado; a lateral seletiva v06, documentada em [28-lateral-seletiva-v6f.md](28-lateral-seletiva-v6f.md), aguarda aprovação visual.
