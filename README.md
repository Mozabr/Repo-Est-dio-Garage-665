...
> **Retomada em outra conta/computador:** comece por [HANDOFF.md](HANDOFF.md). Ele registra o ponto exato do v6f, o doador pago que não deve ser regenerado, as pendências e a instalação reproduzível.
