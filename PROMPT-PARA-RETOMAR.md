...
Não reinicie o projeto e não repita etapas concluídas. O foco atual é a vista dianteira 3/4 da Porsche Panamera na harmonização integral v8. Leia também `30-harmonizacao-integral-v8.md`. Por decisão explícita do usuário, `refinamento-dianteira-v6/teste-M11-capo-centro-api/geracao-bruta-api.png` é a autoridade visual e geométrica do quadro atual. A candidata a avaliar é `refinamento-dianteira-v8/harmonizacao-integral-v03/candidato-quadro-completo.png`. O doador integral já existe; nunca repita essa geração nem chamadas pagas cujos doadores estejam arquivados.
...
Avalie primeiro a v03, que já harmoniza portas, teto, para-brisa e vidros laterais com transferência somente de luminância de baixa frequência. O vidro deve continuar translúcido. Se uma área falhar visualmente, redesenhe uma máscara física contínua apenas para ela; não use as v01/v02, que têm emenda na M13. Ao final, gere um único master/Feed 4096x3072, Story horizontal 3840x2160 e Webmotors 1920x1440. Não gere os formatos separadamente.
