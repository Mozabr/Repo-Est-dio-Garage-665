...
Não reinicie o projeto e não repita etapas concluídas. O foco atual é a vista dianteira 3/4 da Porsche Panamera, no pipeline de material v6f. O capô v25 foi aprovado e está congelado. O doador pago M13 já existe; nunca execute novamente `./scripts/executar_teste_m13_api_v6f.sh`. A composição v02 foi reprovada por mancha clara. A v03 reutiliza localmente apenas a baixa frequência de Lab L, preserva cor, textura e geometria da fonte e aguarda validação visual humana. M14 e M15 permanecem bloqueadas até a aprovação explícita de M13.
